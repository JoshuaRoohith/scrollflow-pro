...
function FeatureDetail() {
  ...
  return (
    <main className="overflow-x-hidden">
      <section className="band-lavender px-6 pb-20 pt-36 sm:pt-44">
            ...
            {feature.columns ? (
              ...
              <ul className="grid gap-4 sm:grid-cols-2">
                {feature.bullets?.map((b, i) => (
                  <li
                    key={b}
                    className="flex gap-3 rounded-2xl bg-muted/60 p-5 text-sm leading-relaxed text-muted-foreground transition-transform duration-300 hover:-translate-y-1"
        ...
        <div className="mx-auto mt-12 flex max-w-5xl flex-wrap items-center justify-between gap-4">
          <Link
            to="/features/$slug"
